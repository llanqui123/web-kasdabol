            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title"> Registrar de Productos</h4>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="nombre" value="{{$producto->nombre}}" id="nombre" aria-describedby="helpId" >
                    </div>
                    <div class="form-group">
                        <label for="precio_venta">Precio de Venta</label>
                        <input type="number" class="form-control" name="precio_venta" id="precio_venta" value="{{$producto->precio_venta}}"  aria-describedby="helpId" >
                    </div>
                    <div class="form-group">
